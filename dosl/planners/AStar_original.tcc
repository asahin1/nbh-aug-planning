...
#ifndef __DOSL_AStar_original_TCC
#define __DOSL_AStar_original_TCC
// user-readable
#define DOSL_ALGORITHM_AStar_original
...
class AStar_original
{
public:
    declare_alg_name("AStar_original"); // macro from '_planner_bits'
...
// Constants
        ...
        {
            _dosl_default_fun_warn("AStar::Algorithm::getStartNodes");
...
AStar_original::Algorithm<AlgDerived, NodeType, CostType>::Algorithm(AlgDerived *shared_instance_p) : _this(static_cast<AlgDerived *>(this))
{
...
template <class AlgDerived, class NodeType, class CostType>
void AStar_original::Algorithm<AlgDerived, NodeType, CostType>::generate_successors(NodeType *node_in_hash_p)
{
...
template <class AlgDerived, class NodeType, class CostType>
void AStar_original::Algorithm<AlgDerived, NodeType, CostType>::search(void)
{
...
void AStar_original::Node<NodeType, CostType>::clear_search_data(unsigned int mode)
{
...
template <class AlgDerived, class NodeType, class CostType>
void AStar_original::Algorithm<AlgDerived, NodeType, CostType>::clear(unsigned int mode)
{
    NodeType *thisNodeInHash_p;
...
template <class AlgDerived, class NodeType, class CostType>
std::vector<NodeType *> AStar_original::Algorithm<AlgDerived, NodeType, CostType>::reconstruct_pointer_path(NodeType n)
{
    _dosl_verbose_head(1);
...
AStar_original::Algorithm<AlgDerived, NodeType, CostType>::reconstruct_weighted_pointer_path(NodeType n)
{
